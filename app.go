...
func (a *App) Initialize() {
	...
	//
	// FORCE POPULATE TABLES UPON RUN ***REMOVE***
	//
	a.importData()
	//
...
func (a *App) initializeRoutes() {
	...
	// Routers for handling everything that is done through the webpage
	...
	a.Router.HandleFunc("/notes", a.notesHandler).Methods("GET")
