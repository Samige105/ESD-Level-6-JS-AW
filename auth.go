...
func (a *App) registerHandler(w http.ResponseWriter, r *http.Request) {
	...
	defaultArray = append(defaultArray, -1)
	...
	case err == sql.ErrNoRows:
		...
		// insert to database
		_, err = a.db.Exec(`INSERT INTO users(username, password, role, user_notes) VALUES($1, $2, $3, $4)`,
			username, hashedPassword, role, defaultArray)
		checkInternalServerError(err, w)
	case err != nil:
